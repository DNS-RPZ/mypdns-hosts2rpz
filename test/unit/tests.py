...
class PipelineOmitLongTokensTest(TestCase):
    ...
    def test_when_subdomains_are_disabled(self):
        ...
        result = list(
            domain + ".rpz.example.com" for domain in pl_omit_long_tokens(mtl)(domains)
        )
...
@patch("mypdns_hosts2rpz.urlopen")
class IntegrationTests(TestCase):
    ...
    def setUp(self):
        ...
        self.settings = MagicMock(
            ...
            block_list_urls=[
                "http://lists.example.com/example_list_one.txt",
